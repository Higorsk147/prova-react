...
import { Row, Card, Container, Nav } from 'react-bootstrap'
    ...
    return (
        ...
        <body class="sidebar-menu-collapsed">
            <div className="main-content">
                ...
                {/* <!-- content --> */}
                <Container fluid className="container container-fluid content-top-gap">

                    {/* <!-- breadcrumbs --> */}
                    <Nav.Item aria-label="breadcrumb" className=" mb-4">
                    ...
                    {/* <!-- card heading --> */}
                    <Card.Header className="card cards__heading">
